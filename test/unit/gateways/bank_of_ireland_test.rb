...
class BankOfIrelandTest < Test::Unit::TestCase
  def setup
    @gateway = BankOfIrelandGateway.new(some_credential: 'login', another_credential: 'password')
  ...
  def successful_purchase_response
    %(
      ...
      $ DEBUG_ACTIVE_MERCHANT=true ruby -Itest \
        test/remote/gateways/remote_bank_of_ireland_test.rb \

...
class RemoteBankOfIrelandTest < Test::Unit::TestCase
  def setup
    @gateway = BankOfIrelandGateway.new(fixtures(:bank_of_ireland))
  ...
  def test_invalid_login
    gateway = BankOfIrelandGateway.new(login: '', password: '')
